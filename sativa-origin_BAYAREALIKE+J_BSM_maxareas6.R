...
wd = np("/data/01/user109/map-sativa/NC_change_sativa132/BioGeoBEARS/Ancestral_region_reconstruction_BSM")
setwd(wd)
...
#######################################################
# Biogeographical Stochastic Mapping (BSM) on BAYAREALIKE results
#######################################################
#######################################################
#######################################################
...
pdffn = paste0("sativa_", model_name, "_M0_unconstrained.pdf")
pdf(pdffn, width=25, height=35)

analysis_titletxt = paste0(model_name, " on sativa")
...
# States
res2 = plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="text", label.offset=NULL, tipcex=2.0, statecex=1.8, splitcex=1.2, titlecex=2.0, plotlegend = TRUE, legend_ncol = NULL, legend_cex = 2, plotsplits=FALSE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=tr, tipranges=tipranges)

# Pie chart
plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="pie", label.offset=NULL, tipcex=2.0, statecex=0.33, splitcex=1.2, titlecex=2.0, plotlegend = TRUE, legend_ncol = NULL, legend_cex = 2, plotsplits=FALSE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=tr, tipranges=tipranges)
...
#######################################################
# Stochastic mapping on BAYAREALIKE M3b stratified with islands coming up
#######################################################
...
pdf(file=pdffn, width=25, height=35)
...
pdffn = paste0(model_name, "_", length(clado_events_tables), "BSMs_M0_unconstrained.pdf")
pdf(file=pdffn, width=25, height=35)
...
#######################################################
#######################################################
# Biogeographical Stochastic Mapping (BSM) on BAYAREALIKE+J results
#######################################################
#######################################################
#######################################################
