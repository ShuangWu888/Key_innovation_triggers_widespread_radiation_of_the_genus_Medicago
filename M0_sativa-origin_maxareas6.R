...
wd = np("/data/01/user109/map-sativa/NC_change_sativa132/BioGeoBEARS/Ancestral_region_reconstruction_xiu")
setwd(wd)
...
trfn = "/data/01/user109/map-sativa/NC_change_sativa132/BioGeoBEARS/r8s.84species-lowcop.newtime-smooth_100.out.timetree.rename.prune.reverse_order.newick"
geogfn = "/data/01/user109/map-sativa/NC_change_sativa132/BioGeoBEARS/sativa_origin_no-outgroup_rm-Duplicates_geog"
...
pdffn = "tree.pdf"
pdf(file=pdffn, width=25, height=40)

tr = read.tree(trfn)
tr
plot(tr)
title("sativa origin from Wu Shuang (2021)")
...
runslow = TRUE
resfn = "sativa_DEC_M0_unconstrained.Rdata"
if (runslow)
    {
...
resfn = "sativa_DEC+J_M0_unconstrained.Rdata"
runslow = TRUE
if (runslow)
    {
...
# PDF plots
#######################################################
pdffn = "sativa_DEC_vs_DEC+J_M0_unconstrained.pdf"
pdf(pdffn, width=25, height=35)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on sativa M0_unconstrained"
...
# States
res2 = plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="text", label.offset=NULL, tipcex=2, statecex=1.8, splitcex=1.2, titlecex=3.0, plotlegend = TRUE, legend_ncol = NULL, legend_cex = 3, plotsplits=FALSE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=tr, tipranges=tipranges)

# Pie chart
plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="pie", label.offset=NULL, tipcex=2, statecex=0.33, splitcex=1.2, titlecex=3.0, plotlegend = TRUE, legend_ncol = NULL, legend_cex = 3, plotsplits=FALSE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=tr, tipranges=tipranges)

#######################################################
# Plot ancestral states - DECJ
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on sativa M0_unconstrained"
...
# States
res1 = plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="text", label.offset=NULL, tipcex=2.0, statecex=1.8, splitcex=1.2, titlecex=3.0, plotlegend = TRUE, legend_ncol = NULL, legend_cex = 3, plotsplits=FALSE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=tr, tipranges=tipranges)

# Pie chart
plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="pie", label.offset=NULL, tipcex=2.0, statecex=0.33, splitcex=1.2, titlecex=3.0, plotlegend = TRUE, legend_ncol = NULL, legend_cex = 3, plotsplits=FALSE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=tr, tipranges=tipranges)
...
runslow = TRUE
resfn = "sativa_DIVALIKE_M0_unconstrained.Rdata"
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
    res    
...
resfn = "sativa_DIVALIKE+J_M0_unconstrained.Rdata"
runslow = TRUE
if (runslow)
    {
    #sourceall("/Dropbox/_njm/__packages/BioGeoBEARS_setup/")
...
pdffn = "sativa_DIVALIKE_vs_DIVALIKE+J_M0_unconstrained.pdf"
pdf(pdffn, width=25, height=35)

#######################################################
# Plot ancestral states - DIVALIKE
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE on sativa M0_unconstrained"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE+J on sativa M0_unconstrained"
...
runslow = TRUE
resfn = "sativa_BAYAREALIKE_M0_unconstrained.Rdata"
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
    res    
...
resfn = "sativa_BAYAREALIKE+J_M0_unconstrained.Rdata"
runslow = TRUE
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
...
pdffn = "sativa_BAYAREALIKE_vs_BAYAREALIKE+J_M0_unconstrained.pdf"
pdf(pdffn, width=25, height=35)

#######################################################
# Plot ancestral states - BAYAREALIKE
#######################################################
analysis_titletxt ="BioGeoBEARS BAYAREALIKE on sativa M0_unconstrained"
...
#######################################################
analysis_titletxt ="BioGeoBEARS BAYAREALIKE+J on sativa M0_unconstrained"
